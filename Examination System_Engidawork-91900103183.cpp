...
public:
     ...
     int menu3();
     bool IsLoggedIn();
     friend void displayGrade();///friend function 
}m;
void loadingBar();
...
void Manager :: Signup()
{
    ...
    fout<< userName<<endl;
    fout<< password<<endl; //write in a file
	fout.close();
	loadingBar();
...
int Manager :: menu3()
{
   ...
   while(flag)
   {
       ...
       switch(ch)
       {
           ...
           case 2: m.Signup(); break;
           case 0: exit(0);
           default : cout<<"\n\t\tIncorrect input, Please enter again"<<endl; break;
       }
   }
}
///=====================END OF REGISTRATION======================
...
class Teacher///base class
{
	...
	void getData();///Polymorphism applied ->
	void display();
}t;
///====================STRAT STUDENT CLASS=======================
///==============================================================
